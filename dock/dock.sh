...
echo -e "[ ${BLUE}$(date)${RESET_COLOR} ] ( ${GREEN}Dock${RESET_COLOR} ) ${B_PURPLE}-${RESET_COLOR} add qtpass"
dockutil --add '/Applications/QtPass.app' --no-restart
...
dockutil --add '/Applications/Firefox Nightly.app' --no-restart
