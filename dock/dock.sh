...
echo -e "[ ${BLUE}$(date)${RESET_COLOR} ] ( ${GREEN}Dock${RESET_COLOR} ) ${B_PURPLE}-${RESET_COLOR} add mail"
...
dockutil --add  "$HOME/Library/Application Support/Autodesk/webdeploy/production/Autodesk Fusion 360.app" --no-restart
